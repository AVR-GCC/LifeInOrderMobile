...
import type { GetValue, HabitWithValues, MainProps, SetValue } from '../types';
...
const DayScreen: React.FC<DayScreenProps> = React.memo(function DayScreen({ data, getValue, setValue }) {
